...
const showGoogleDocsWarning = function () {
  $.getJSON(
    '/api/v1/courses/' + ENV.context_asset_string.split('_')[1] + '/enrollments?user_id=self',
    function (enrollments) {
      let usage = 'google_docs'
      ...
      ReactDOM.render(
        React.createElement(SFUPrivacyNotice, {
          alertStyle: 'alert',
          usage
        }),
